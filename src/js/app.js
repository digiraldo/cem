...
function navegacionFija() {
    ...
    const bannerVision  = document.querySelector('.banner-vision');
    const body = document.querySelector('body');

    window.addEventListener('scroll', function () {
        //console.log(bannerVision.getBoundingClientRect());

        if (bannerVision.getBoundingClientRect().top < 0) {
